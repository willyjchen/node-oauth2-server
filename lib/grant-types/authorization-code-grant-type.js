...
AuthorizationCodeGrantType.prototype.saveToken = function(user, client, authorizationCode, scope) {
  var fns = [
    ...
    this.generateIdToken(client, user, scope),
  ...
  return Promise.all(fns)
    .bind(this)
    .spread(function(scope, accessToken, idToken, refreshToken, accessTokenExpiresAt, refreshTokenExpiresAt) {
      /* Not copy null idToken */
